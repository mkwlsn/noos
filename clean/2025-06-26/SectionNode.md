...
[View more →](/plugin-docs/api/properties/SectionNode-resizewithoutconstraints/)### devStatus: DevStatus
...
[View more →](/plugin-docs/api/properties/nodes-findwidgetnodesbywidgetid/)## Geometry-related properties
