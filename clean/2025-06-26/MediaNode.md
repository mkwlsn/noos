...
[View more →](/plugin-docs/api/properties/MediaNode-resize/)### resizeWithoutConstraints(width: number, height: number): void

Resizes the media node without constraints.

[View more →](/plugin-docs/api/properties/MediaNode-resizewithoutconstraints/)### clone(): MediaNode
