...
[View more →](/plugin-docs/api/properties/InstanceNode-swapcomponent/)### setProperties(properties: { [propertyName: string]: string | boolean | VariableAlias }): void
...
[View more →](/plugin-docs/api/properties/InstanceNode-scalefactor/)### exposedInstances: InstanceNode[] [readonly]
