---
title: ComponentSetNode
slug: ComponentSetNode
...
owner: figma
version: 1.0
content_hash: 8a5bd4e0fe856d2c
token_count: 10113
---
# ComponentSetNode

A component set contains the variants of a component. It behaves much like a normal frame would, but all of its children are [`ComponentNode`](/plugin-docs/api/ComponentNode/)
s.

Be aware that some component sets reflect items in the team library that are used within this file. Those component sets and their children are read-only, though you may create new instances of the [`ComponentNode`](/plugin-docs/api/ComponentNode/)
s that are inside them.
