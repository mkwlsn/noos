...
owner: figma
version: 1.0
content_hash: fd3ddaa95d331eb2
token_count: 9593
---
# FrameNode

The frame node is a container used to define a layout hierarchy. It is similar to `` in HTML. It is different from [`GroupNode`](/plugin-docs/api/GroupNode/)
, which is closer to a folder for layers. Frames can be created using [`figma.createFrame`](/plugin-docs/api/properties/figma-createframe/)
.
