...
If the plugin manifest contains `"documentAccess": "dynamic-page"`, this property is write-only. Use [`getMainComponentAsync`](/plugin-docs/api/InstanceNode/#getmaincomponentasync)
 to read the value.
