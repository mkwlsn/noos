...
List of [`Effect`](/plugin-docs/api/Effect/)
 to replace the `effects` property with.

### boundVariables?: { readonly [field in VariableBindableEffectStyleField]?: VariableAlias[]} [readonly]
