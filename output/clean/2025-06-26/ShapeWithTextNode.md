---
title: ShapeWithTextNode
slug: ShapeWithTextNode
...
[View more →](/plugin-docs/api/properties/ShapeWithTextNode-rotation/)### resize(width: number, height: number): void

Resize the ShapeWithText.

[View more →](/plugin-docs/api/properties/ShapeWithTextNode-resize/)### rescale(scale: number): void

Rescale the ShapeWithText.

[View more →](/plugin-docs/api/properties/ShapeWithTextNode-rescale/)### clone(): ShapeWithTextNode
