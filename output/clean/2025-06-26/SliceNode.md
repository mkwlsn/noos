...
[View more →](/plugin-docs/api/properties/ExplicitVariableModesMixin-setexplicitvariablemodeforcollection/)## Layout-related properties
...
[View more →](/plugin-docs/api/properties/nodes-rescale/)## Export-related properties
