...
[View more →](/plugin-docs/api/properties/WidgetNode-clonewidget/)### setWidgetSyncedState(syncedState: { [name: string]: any }, syncedMap?: { [mapName: string]: { [key: string]: any } }): void
...
[View more →](/plugin-docs/api/properties/WidgetNode-setwidgetsyncedstate/)## Base node properties
...
[View more →](/plugin-docs/api/properties/nodes-exportasync/)## Stickable properties
