---
title: >-
  getRangeTextDecorationOffset(start: number, end: number): TextDecorationOffset
  | figma.mixed | null + setRangeTextDecorationOffset(start: number, end:
  number, value: TextDecorationOffset): void
slug: TextNode-getrangetextdecorationoffsetstart-number
...
owner: figma
version: 1
content_hash: 99f322fe11fbe28b
token_count: 66
chunk_title: >-
  getRangeTextDecorationOffset(start: number, end: number): TextDecorationOffset
  | figma.mixed | null + setRangeTextDecorationOffset(start: number, end:
  number, value: TextDecorationOffset): void
chunk_slug: TextNode-getrangetextdecorationoffsetstart-number
chunk_index: 19
chunk_of_total: 90
