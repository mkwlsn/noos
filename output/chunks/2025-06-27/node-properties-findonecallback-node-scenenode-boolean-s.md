...
slug: node-properties-findonecallback-node-scenenode-boolean-s
...
owner: figma
version: 1
content_hash: 117ae2a157c0301f
token_count: 178
chunk_title: 'findOne(callback: (node: SceneNode) => boolean): SceneNode | null'
chunk_slug: node-properties-findonecallback-node-scenenode-boolean-s
chunk_index: 54
chunk_of_total: 192
