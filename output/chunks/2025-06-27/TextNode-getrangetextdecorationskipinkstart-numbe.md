...
title: >-
  ...
  figma.mixed | null + setRangeTextDecorationSkipInk(start: number, end: number,
  value: boolean): void
slug: TextNode-getrangetextdecorationskipinkstart-numbe
...
owner: figma
version: 1
content_hash: 3c926abc905f5568
token_count: 66
chunk_title: >-
  getRangeTextDecorationSkipInk(start: number, end: number): boolean |
  figma.mixed | null + setRangeTextDecorationSkipInk(start: number, end: number,
  value: boolean): void
chunk_slug: TextNode-getrangetextdecorationskipinkstart-numbe
chunk_index: 22
chunk_of_total: 90
