---
title: >-
  getRangeBoundVariable(start: number, end: number, field:
  VariableBindableTextField): VariableAlias | null | figma.mixed +
  setRangeBoundVariable(start: number, end: number, field:
  VariableBindableTextField, variable: Variable | null): void
slug: TextPathNode-getrangeboundvariablestart-number-end-nu
...
chunk_title: >-
  ...
  setRangeBoundVariable(start: number, end: number, field:
  VariableBindableTextField, variable: Variable | null): void
chunk_slug: TextPathNode-getrangeboundvariablestart-number-end-nu
chunk_index: 19
chunk_of_total: 74
