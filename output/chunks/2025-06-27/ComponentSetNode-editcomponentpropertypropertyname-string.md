---
title: >-
  editComponentProperty(propertyName: string, newValue: { name: string;
  defaultValue: string | boolean | VariableAlias; preferredValues:
  InstanceSwapPreferredValue[] }): string
slug: ComponentSetNode-editcomponentpropertypropertyname-string
...
owner: figma
version: 1
content_hash: 69d13f5bdc0b1a40
token_count: 155
chunk_title: >-
  editComponentProperty(propertyName: string, newValue: { name: string;
  defaultValue: string | boolean | VariableAlias; preferredValues:
  InstanceSwapPreferredValue[] }): string
chunk_slug: ComponentSetNode-editcomponentpropertypropertyname-string
chunk_index: 92
chunk_of_total: 93
