...
slug: node-properties-layoutalign-min-center-max-stretch-inher
...
owner: figma
version: 1
content_hash: 8181bede38abebdf
token_count: 158
chunk_title: 'layoutAlign: ''MIN'' | ''CENTER'' | ''MAX'' | ''STRETCH'' | ''INHERIT'''
chunk_slug: node-properties-layoutalign-min-center-max-stretch-inher
chunk_index: 96
chunk_of_total: 192
