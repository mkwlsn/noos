...
slug: TextPathNode-getrangefillstyleidstart-number-end-numb
...
owner: figma
version: 1
content_hash: 720f1e8dd9c93479
token_count: 65
chunk_title: >-
  getRangeFillStyleId(start: number, end: number): string | figma.mixed +
  setRangeFillStyleIdAsync(start: number, end: number, styleId: string): Promise
chunk_slug: TextPathNode-getrangefillstyleidstart-number-end-numb
chunk_index: 17
chunk_of_total: 74
...
merged_titles:
  - 'getRangeFillStyleId(start: number, end: number): string | figma.mixed'
  - >-
    setRangeFillStyleIdAsync(start: number, end: number, styleId: string):
    Promise
compiler: noos-figma
---
