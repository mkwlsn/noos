---
title: >-
  getRangeTextDecorationColor(start: number, end: number): TextDecorationColor |
  figma.mixed | null + setRangeTextDecorationColor(start: number, end: number,
  value: TextDecorationColor): void
slug: TextNode-getrangetextdecorationcolorstart-number-
...
owner: figma
version: 1
content_hash: fcd73987f97fa790
token_count: 65
chunk_title: >-
  getRangeTextDecorationColor(start: number, end: number): TextDecorationColor |
  figma.mixed | null + setRangeTextDecorationColor(start: number, end: number,
  value: TextDecorationColor): void
chunk_slug: TextNode-getrangetextdecorationcolorstart-number-
chunk_index: 21
chunk_of_total: 90
