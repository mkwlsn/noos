...
title: >-
  ...
  getRangeOpenTypeFeatures(start: number, end: number): { readonly [feature in
  OpenTypeFeature]: boolean} | figma.mixed
slug: TextPathNode-setrangetextcasestart-number-end-number-
...
owner: figma
version: 1
content_hash: bc8599a8be91a19a
token_count: 78
chunk_title: >-
  setRangeTextCase(start: number, end: number, value: TextCase): void +
  getRangeOpenTypeFeatures(start: number, end: number): { readonly [feature in
  OpenTypeFeature]: boolean} | figma.mixed
chunk_slug: TextPathNode-setrangetextcasestart-number-end-number-
chunk_index: 10
chunk_of_total: 74
