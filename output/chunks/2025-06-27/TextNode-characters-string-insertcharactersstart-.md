---
title: >-
  characters: string + insertCharacters(start: number, characters: string,
  useStyle?: 'BEFORE' | 'AFTER'): void
slug: TextNode-characters-string-insertcharactersstart-
...
owner: figma
version: 1
content_hash: bc65f7eaef917a30
token_count: 80
chunk_title: >-
  characters: string + insertCharacters(start: number, characters: string,
  useStyle?: 'BEFORE' | 'AFTER'): void
chunk_slug: TextNode-characters-string-insertcharactersstart-
chunk_index: 5
chunk_of_total: 90
