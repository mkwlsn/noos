...
Defines all the possible keys in the map of OpenType features from the [openTypeFeatures](/plugin-docs/api/properties/TextNode-opentypefeatures/)
 property.
