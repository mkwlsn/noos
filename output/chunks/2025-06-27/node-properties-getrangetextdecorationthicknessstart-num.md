...
title: >-
  ...
  TextDecorationThickness | figma.mixed | null + getRangeTextStyleId(start:
  number, end: number): string | figma.mixed
slug: node-properties-getrangetextdecorationthicknessstart-num
...
owner: figma
version: 1
content_hash: dd0c6bb5c5e63466
token_count: 85
chunk_title: >-
  getRangeTextDecorationThickness(start: number, end: number):
  TextDecorationThickness | figma.mixed | null + getRangeTextStyleId(start:
  number, end: number): string | figma.mixed
chunk_slug: node-properties-getrangetextdecorationthicknessstart-num
chunk_index: 75
chunk_of_total: 192
