---
title: >-
  resizeRow(rowIndex: number, height: number): void + resizeColumn(columnIndex:
  number, width: number): void
slug: TableNode-resizerowrowindex-number-height-number-v
...
owner: figma
version: 1
content_hash: b9fe4fed5642c537
token_count: 94
chunk_title: >-
  resizeRow(rowIndex: number, height: number): void + resizeColumn(columnIndex:
  number, width: number): void
chunk_slug: TableNode-resizerowrowindex-number-height-number-v
chunk_index: 4
chunk_of_total: 36
