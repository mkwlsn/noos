...
title: >-
  ...
  end?: number): Array> + getRangeFontSize(start: number, end: number): number |
  figma.mixed
slug: TextPathNode-getstyledtextsegmentsfields-styledtextse
...
owner: figma
version: 1
content_hash: 890d341ded4c0975
token_count: 72
chunk_title: >-
  getStyledTextSegments)[]>(fields: StyledTextSegmentFields, start?: number,
  end?: number): Array> + getRangeFontSize(start: number, end: number): number |
  figma.mixed
chunk_slug: TextPathNode-getstyledtextsegmentsfields-styledtextse
chunk_index: 7
chunk_of_total: 74
