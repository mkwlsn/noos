---
title: >-
  createNodeFromJSXAsync(jsx: any): Promise + combineAsVariants(nodes:
  ReadonlyArray, parent: BaseNode & ChildrenMixin, index?: number):
  ComponentSetNode
slug: figma-createnodefromjsxasyncjsx-any-promise-co
...
owner: figma
version: 1
content_hash: 0fd3d737f03e9ed7
token_count: 130
chunk_title: >-
  createNodeFromJSXAsync(jsx: any): Promise + combineAsVariants(nodes:
  ReadonlyArray, parent: BaseNode & ChildrenMixin, index?: number):
  ComponentSetNode
chunk_slug: figma-createnodefromjsxasyncjsx-any-promise-co
chunk_index: 34
chunk_of_total: 70
...
merged_titles:
  ...
  - >-
    combineAsVariants(nodes: ReadonlyArray, parent: BaseNode & ChildrenMixin,
    index?: number): ComponentSetNode
compiler: noos-figma
---
