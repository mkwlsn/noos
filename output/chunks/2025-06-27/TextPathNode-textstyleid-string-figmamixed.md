---
title: 'textStyleId: string | figma.mixed'
slug: TextPathNode-textstyleid-string-figmamixed
...
owner: figma
version: 1
content_hash: f6608d2a265be20f
token_count: 98
chunk_title: 'textStyleId: string | figma.mixed'
chunk_slug: TextPathNode-textstyleid-string-figmamixed
chunk_index: 5
chunk_of_total: 74
...
If the manifest contains`"documentAccess": "dynamic-page"`, this property is read-only. Use [`setTextStyleIdAsync`](/plugin-docs/api/TextPathNode/#settextstyleidasync)
 to update the style.
