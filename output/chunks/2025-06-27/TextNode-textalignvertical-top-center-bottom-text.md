---
title: >-
  textAlignVertical: 'TOP' | 'CENTER' | 'BOTTOM' + textAutoResize: 'NONE' |
  'WIDTH_AND_HEIGHT' | 'HEIGHT' | 'TRUNCATE'
slug: TextNode-textalignvertical-top-center-bottom-text
...
owner: figma
version: 1
content_hash: 2ca596d24f8bf175
token_count: 92
chunk_title: >-
  textAlignVertical: 'TOP' | 'CENTER' | 'BOTTOM' + textAutoResize: 'NONE' |
  'WIDTH_AND_HEIGHT' | 'HEIGHT' | 'TRUNCATE'
chunk_slug: TextNode-textalignvertical-top-center-bottom-text
chunk_index: 1
chunk_of_total: 90
